...
const std::vector<VKVertex> vertices = {
	{ Vector2(-0.5f, -0.5f),	Vector3(1.0f, 0.0f, 0.0f),	Vector2(1.0f, 0.0f) },
	{ Vector2(0.5f, -0.5f),		Vector3(0.0f, 1.0f, 0.0f),	Vector2(0.0f, 0.0f) },
	{ Vector2(0.5f, 0.5f),		Vector3(0.0f, 0.0f, 1.0f),	Vector2(0.0f, 1.0f)},
	{ Vector2(-0.5f, 0.5f),		Vector3(1.0f, 1.0f, 1.0f),	Vector2(1.0f, 1.0f)}
};
...
void VKRenderer::CreateGraphicsPipeline(){
	...
	rasterizer.cullMode = VK_CULL_MODE_BACK_BIT; //TODO - Put this back when done testing crap
...
void VKRenderer::UpdateUniformBuffer(uint32_t currentImage){
	...
	//ubo.model = Matrix4::Rotate(time * 90.0f, Vector3::worldUp); //Use this for spinning
	ubo.view = Matrix4::LookAt(Vector3(0.0f, 0.0f, 2.0f), Vector3(0.0f, 0.0f, 0.0f), Vector3::worldUp);
